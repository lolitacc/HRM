          ...
          <div class="advContent">
            ...
            <div class="contentItem">
              <ul class="noticeList">
                <li>
                  <div class="item">
                    <img src="@/assets/common/aa.png" alt="">
                    <div>
                      <p><span class="col">朱继柳</span> 发布了 第1期“技术大讲堂”互动讨论获奖名单公布</p>
                ...
                <li>
                  <div class="item">
                    <img src="@/assets/common/aa.png" alt="">
                    <div>
                      <p><span class="col">李广权</span> 发布了 第2期”技术大讲堂”互动讨论获奖名单公布</p>
                      <p>2022-04-01 15:21:38</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="item">
                    <img src="@/assets/common/aa.png" alt="">
                    <div>
                      <p><span class="col">朱继柳</span> 发布了 第3期“技术大讲堂”互动讨论获奖名单公布</p>
                      <p>2022-04-09 15:21:38</p>
                    </div>
                  </div>
                </li>
              </ul>
...
export default {
  name: 'Dashboard',
  components: { Canlendar, Radar },
  data() {
    return {
      defaultImg: require('@/assets/common/bigUser.png'),
      showDialog: false,
      ruleForm: {
        exceptTime: '',
        reason: '',
...
.box-card {
  ...
  .headTit {
    span {
      border-bottom: 4px solid #F790AF;
      padding-bottom: 10px;
    }
  }
}
