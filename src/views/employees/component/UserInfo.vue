            ...
            <el-col :span="12">
              <el-form-item label="聘用形式">
                <el-select v-model="userInfo.formOfEmployment" class="inputW">
                  <el-option
                    v-for="item in StaffEnum.hireType"
                    :key="item.id"
                    :label="item.value"
                    :value="item.id"
                  />
          ...
          <div class="block">
            ...
            <el-form-item label="最高学历">
              <el-select v-model="formData.theHighestDegreeOfEducation" class="inputW2">
                <el-option
                  v-for="item in StaffEnum.highestDegree"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                />
            ...
            <el-form-item label="国家/地区">
              <el-select v-model="formData.nationalArea" class="inputW2">
                <el-option
                  v-for="item in StaffEnum.isOverseas"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                />
            ...
            <el-form-item label="婚姻状况">
              <el-select v-model="formData.maritalStatus" class="inputW2">
                <el-option
                  v-for="item in StaffEnum.maritaStatus"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                />
            ...
            <el-form-item label="星座">
              <el-select v-model="formData.constellation" class="inputW2">
                <el-option
                  v-for="item in StaffEnum.constellation"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                />
            ...
            <el-form-item label="血型">
              <el-select v-model="formData.bloodType" class="inputW2">
                <el-option
                  v-for="item in StaffEnum.bloodType"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                />
          ...
          <div class="block">
            ...
            <el-form-item label="学历类型">
              <el-select v-model="formData.educationalType" placeholder="请选择">
                <el-option
                  v-for="item in StaffEnum.educationType"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                />
